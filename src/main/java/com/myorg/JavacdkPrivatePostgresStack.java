...
public class JavacdkPrivatePostgresStack extends Stack {
    public JavacdkPrivatePostgresStack(final Construct scope, final String id) {
        this(scope, id, null);
    }

    public JavacdkPrivatePostgresStack(final Construct scope, final String id, final StackProps props) {
        ...
        Role bastionIamRole = Role.Builder.create(this, "Bastion Role")
      		  .assumedBy(new ServicePrincipal("ec2.amazonaws.com"))
      	       .assumedBy(new ServicePrincipal("ssm.amazonaws.com"))
      	         .description("Bastion Role")
      	         .build();
        bastionIamRole.addManagedPolicy(ManagedPolicy.fromAwsManagedPolicyName("AmazonSSMManagedInstanceCore"));

        
        SecurityGroup bastionSecurityGroup = SecurityGroup.Builder.create(this, "bastionSecurityGroup")
      	      .vpc(vpc)
      	      .description("Security Group for the bastion instance")
      	      .securityGroupName("bastionSecurityGroup")
      	      .build(); 
        //We are allowing public access here but you can configure this to your own IPs that you configure
        bastionSecurityGroup.addIngressRule(Peer.anyIpv4(), Port.allTraffic(), "Allow any traffic");
        bastionSecurityGroup.addIngressRule(Peer.anyIpv4(), Port.tcp(22), "Allow SSH into Bastion");


        //Bastion Host
        BastionHostLinux bastionHost = BastionHostLinux.Builder.create(this, "BastionHost")
      	         .vpc(vpc)
        ...
        //Allowing access from the bastion Security group (Not public access)
        ...
        CfnOutput.Builder.create(this, "ZJ BastionHost instanceId:")
        .description("")
         .value("Bastion Host Instance Id:"+ bastionHost.getInstanceId())
         .build();
